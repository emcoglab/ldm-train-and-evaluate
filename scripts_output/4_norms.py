...
def model_performance_bar_graphs(similarity_results_df: DataFrame, window_radius: int,
    ...
    filtered_df: DataFrame = similarity_results_df.copy()
...
def figures_score_vs_radius(similarity_results):
    ...
    for distance in [d.name for d in DistanceType]:
        ...
        figure_name = f"norms {distance} {correlation_type}.png"
